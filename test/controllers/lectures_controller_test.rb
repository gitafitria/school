...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post lectures_url, params: { lecture: { description: @lecture.description, is_valid: @lecture.is_valid, name: @lecture.name } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { description: @lecture.description, is_valid: @lecture.is_valid, name: @lecture.name } }
